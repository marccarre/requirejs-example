define(['list_manager', 'knockout', 'i18n!nls/ui_strings', 'task_manager', 'renderer', 'view_models/task', 'text!views/task.html', 'smokesignals'], 
  ...
  function ListViewModel() {
    ...
    this.completeTask = function(taskViewModel) {
      ...
      console.log('Task #' + taskIndex + ' is ' + (this.list.tasks[taskIndex].completed ? '' : 'not') + ' completed.');
    }
